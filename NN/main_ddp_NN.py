...
def parse_args():
    ...
    parser.add_argument('--dist_url', default='tcp://127.0.0.1:13456', type=str, help='url used to set up distributed training')
    ...
    # path
    parser.add_argument('--path', type=str, default='/home/yubinryu/ml/2023/NN/result')
    ...
    parser.add_argument('--w_phy', type=float, default=0, help='weight of physical loss')
...
def main_worker(gpu, world_size, args):
    ...
    if args.restore == 1:
        ...
        checkpoint = torch.load(args.path + '/checkpoint/' + args.restore_file, map_location=loc)
    ...
    for epoch in range(args.start_epoch, last_epoch+1):
        ...
        if epoch % 1 == 0:
            ...
            if torch.cuda.current_device() == 0:
                if val_loss.item() < best_val_loss:
                    ...
                    CHECKPOINT_PATH = args.path + '/' + 'best_model.pth'
                    ...
                    torch.save({'epoch': epoch,
                               ...
                               args.path + '/' + 'checkpoint/checkpoint_model.pt'.format(epoch))
        ...
        if epoch % 1000 == 1:
            ...
            sampling_plot(train_s, u_pred, v_pred, w_pred, points_X, epoch, args.path)
    ...
    #
    # loaded_state_dict = torch.load(args.path + '/best_model.pth')
    ...
    # # plt.show()
    # plt.savefig(args.path + '/Velocity.png', dpi=300)
    # cb1.remove()
    # plt.gca().invert_yaxis()
    #
    ...
    # plt.gca().invert_yaxis()
    # # plt.show()
    # plt.savefig(args.path + '/Initiator.png', dpi=300)
    # cb2.remove()
    # plt.gca().invert_yaxis()
    #
    ...
    # plt.gca().invert_yaxis()
    # # plt.show()
    # plt.savefig(args.path + '/Monomer.png', dpi=300)
    # cb3.remove()
    # plt.gca().invert_yaxis()
    #
    # # Loss Visualization
    ...
    # plt.legend()
    # # plt.show()
    # plt.savefig(args.path + '/train_valid_loss.png', dpi=300)
    #
    # # Loss check
    ...
    # # plt.show()
    # plt.savefig(args.path + '/data_loss.png', dpi=300)
    #
    ...
    # plt.legend(loc='upper right')
    # # plt.show()
    # plt.savefig(args.path + '/physics_loss.png', dpi=300)
    #
    # # uvw loss check
    # plt.figure()
    # plt.plot(x_loss, uvw_loss_data, label='uvw', c='#ae3c60')
    ...
    # plt.legend(loc='upper right')
    # # plt.show()
    # plt.savefig(args.path + '/uvw.png', dpi=300)
    #
    # # P loss check
    # plt.figure()
    # plt.plot(x_loss, P_loss_data, label='P', c='#ffa101')
    # plt.yscale('log')
    # plt.legend(loc='upper right')
    # plt.savefig(args.path + '/pressure.png', dpi=300)
    #
    # # T loss check
    # plt.figure()
    # plt.plot(x_loss, T_loss_data, label='T', c='#ffa778')
    # plt.yscale('log')
    # plt.legend(loc='upper right')
    # plt.savefig(args.path + '/temperature.png', dpi=300)
    #
    # # I loss check
    # plt.figure()
    # plt.plot(x_loss, I_loss_data, label='I', c='#267778')
    ...
    # plt.yscale('log')
    # plt.legend(loc='upper right')
    # plt.savefig(args.path + '/cont.png', dpi=300)
    #
    # # momentum loss check
    # plt.figure()
    # plt.plot(x_loss, moment_loss_data, label='momentum', c='#f3c33c')
    # plt.yscale('log')
    # plt.legend(loc='upper right')
    # plt.savefig(args.path + '/momentum.png', dpi=300)
    #
    # # species loss check
    # plt.figure()
    # plt.plot(x_loss, species_loss_data, label='species', c='#255e79')
    # plt.yscale('log')
    # plt.legend(loc='upper right')
    # plt.savefig(args.path + '/species.png', dpi=300)
    #
    # if torch.cuda.current_device() == 0:
